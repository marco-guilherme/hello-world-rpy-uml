...
TARGET_NAME=MyComponent

all : $(TARGET_NAME)$(EXE_EXT) MyComponent.mak

TARGET_MAIN=MainMyComponent
...
MyClass.obj : MyClass.cpp MyClass.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"MyClass.obj" "MyClass.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) MyComponent.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) MyComponent.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist MyClass.obj erase MyClass.obj
